...
def main():
    ...
    print("Input:", len(plaintext), plaintext)
    print("Bytes:", list(plaintext.encode()))

    inf = padding(plaintext, Nb)
    print("Padding:", len(inf), inf)
    ...
    print(" ", "="*10)
    print("Output:", len(output), list(output))
    ...
    inf = output
    print("Input:", len(inf), inf)
    print("Bytes:", list(inf))
    ...
    print(" ", "="*10)
    print("Padding:", len(output), output)
...
##
## Shift する方向が仕様と違うかも？
## pre : [0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15]
## post: [0, 5, 10, 15, 1, 6, 11, 12, 2, 7, 8, 13, 3, 4, 9, 14]
##
def ShiftRows(state):
    Nb = len(state)
